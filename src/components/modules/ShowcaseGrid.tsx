  ...
  return (
    <div className="grid gap-5 text-wolf-foreground md:grid-cols-2 xl:grid-cols-3">
      {projects.map((project) => (
        <article
          key={project.id}
          className="wolf-card rounded-[1.9rem] border border-wolf-border-strong p-6 transition hover:-translate-y-1 hover:shadow-[0_32px_90px_-60px_rgba(165,205,96,0.35)]"
        >
